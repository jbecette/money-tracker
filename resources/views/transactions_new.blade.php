...
@section('content')
{{-- Debug --}}
{{-- @foreach ($transaction_types as $object)
    {{ $object->id }}|{{$object->bookkeeping}}|{{$object->description}}
    <br>
    @endforeach --}}
                        ...
                        <form method="POST" action="{{route('transactions_new_insert')}}">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check ml-2">
                                        <input class="form-check-input" type="radio" name="transaction-type-radio" id="transaction-type-radio-expense" value="expense" checked="" onclick="transactionTypeSwitch();">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control  w-auto numeric text-right ml-2" id="amount" name="amount" placeholder="$ 0.00" autofocus="autofocus" maxlength="16">
                                    
                                </div>
                                <div class="form-group">
                                    <label for="transaction_comments">Comments</label>
                                    <input type="text" class="form-control w-50 ml-2" id="comments" name="comments" placeholder="Comments">
                                </div>
                                <div class="form-group">
                                </div>
